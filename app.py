...
def dropdown_list():
    return html.Div([dbc.DropdownMenu(
        children=[dbc.DropdownMenu(nav=True,in_navbar=True,label="Main Control Room",
                    children=[dbc.DropdownMenuItem(dcc.Link("InverterRoom1",href="/"))]),
            dbc.DropdownMenu(nav=True,in_navbar=True,label="Layout",
                children=[dbc.DropdownMenuItem(dcc.Link("Layout",href="/layout"))]),
            dbc.DropdownMenu(nav=True,in_navbar=True,label="Trackers",
                    children=[dbc.DropdownMenuItem(dcc.Link("Table",href="/tracker")),
                        dbc.DropdownMenuItem(dcc.Link("Graph", href='/home',)),
                        dbc.DropdownMenuItem(divider=True),
                        dbc.DropdownMenuItem(dcc.Link("Read", href='/read')),
                        dbc.DropdownMenuItem(dcc.Link("Control", href='/control')),
                        dbc.DropdownMenuItem(dcc.Link("Status", href='/status')),
                        dbc.DropdownMenuItem(dcc.Link("Location SetUp", href='/location'))]),
                    dbc.DropdownMenu(nav=True,in_navbar=True,label="SMB's",
                    children=[dbc.DropdownMenuItem(dcc.Link("Table",href="/smb")),
                        dbc.DropdownMenuItem(dcc.Link("Graph", href='/smb_graph'))])],
...
html.A(html.Button("K6",className="mr-1"),href="/home")],style={"border":"2px darkblue solid",'width':'auto',"height":"calc(100vh - 10rem - 1px)"})])
...
html.A(html.Button("K6",className="mr-1"),href="/smb_graph")],style={"border":"2px darkblue solid",'width':'auto', "height":"calc(100vh - 10rem - 1px)"})])
...
def inverters_layout(app):
    return html.Div([dbc.Container([dbc.Row([dbc.Col([dbc.Card([daq.Indicator(label="DC Switch", color="green", value=True,style={'color':'black','font-size':'1rem'})],style={'width':'12rem','top':'1rem','backgroundColor':'white'})]),html.Br(),html.Br(),
        dbc.Col([dbc.Card([daq.Indicator(label="SPD Status", color="green", value=True,style={'color':'black','font-size':'1rem'})],style={'width':'12rem','top':'1rem','backgroundColor':'white'})]),]),html.Br(),
    ...
    return  dbc.Container([
        dbc.Row([
            dbc.Col(
                ...
                value='G1', style={"width":"auto","height":"auto","color":"black"}),
